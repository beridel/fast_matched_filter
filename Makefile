...
all: $(libdir)/matched_filter_GPU.so $(libdir)/matched_filter_CPU.so $(maindir)/matched_filter.mexa64
python_cpu: $(libdir)/matched_filter_CPU.so
python_gpu: $(libdir)/matched_filter_GPU.so 
matlab: $(maindir)/matched_filter.mexa64
.SUFFIXES: .c .cu
...
# build for Matlab
$(maindir)/matched_filter.mexa64: $(srcdir)/matched_filter_mex.c $(srcdir)/matched_filter.c
